...
global.sig = 'https://instagram.com/sirvan.on2' //Link Instagrammu
global.sgh = 'https://github.com/bgmaliy' //Link Githubmu
global.sgc = 'https://chat.whatsapp.com/E7XOV8MzbG52FxWp9XsS81'
global.sdc = '-' //Fill it out using the Discord link, if there is one, just leave it
global.snh = 'https://nhentai.net/' //Hmmm, This is up to you to fill in :v

/*============== PAYMENT ==============*/
global.pdana = '994555647159' //Nomor Danamu
global.ppulsa = '994555647159' //Nomor SimCard Yang Kamu Pake
global.psaweria = 'https://s' //Link Saweriamu Kalo Nggada Ketik - aja

/*============== NOMOR ==============*/
global.nomorbot = '994555647159' //Nomor Bot
global.nomorown = '994555647159' //Nomor Owner
global.namebot = '𝐁𝐠𝐦𝐚𝐥𝐢𝐲𝐁𝐨𝐭' //Nama Bot
global.nameown = '𝚜𝚑𝚒𝚛𝚟𝚊𝚗🤡' // Nama Owner
...
/*============== STAFF ==============*/
global.owner = [
  ['994555647159', 'sʜɪʀᴠᴀɴ🎐', true] //don't change this name and number
  ['994555647159', 'sʜɪʀᴠᴀɴ🎐', false] //Replace your name and number here
...
/*============== WATERMARK ==============*/
global.wm = '「 ʙɢᴍᴀʟɪʏ-ʙᴏᴛ-ᴠ𝟷 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘𝓈𝒽𝒾𝓇𝒸𝒶𝓃- ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = 'ʙɢᴍᴀʟɪʏ-ʙᴏᴛ-ᴠ𝟷'
...
global.titlebot = '🎋 ┊ ʙɢᴍᴀʟɪʏ ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ'
...
/*============== TEXT ==============*/
global.wait = '```「▰▰▰▱▱▱▱▱▱▱」Loading...```'
global.eror = '```404 XƏTA !!!  ```'
global.dtu = 'ɪɴꜱᴛᴀɢʀᴀᴍ'
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = '+994 55 564 71 59'
...
global.packname2 = 'sʜɪʀᴠᴀɴ ᴀʟɪʏᴇғʜ'
